...
class Solution3 {
    func searchMatrix(_ matrix: [[Int]], _ target: Int) -> Bool {
        ...
        return flatArray.contains(target)
    }
}

// Solution 3 : using flatmap to first flatten array and then applying contains on it
let sol3 = Solution3()
print(sol3.searchMatrix([[1,3,5,7],[10,11,16,20],[23,30,34,60]], 13))
print(sol3.searchMatrix([[1,3,5,7],[10,11,16,20],[23,30,34,60]], 3))
